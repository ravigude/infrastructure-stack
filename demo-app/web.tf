...
module "demo_web_asg_scale_up" {
  ...
  scale_type ="up"
  scale_adjustment = "1"
  asg_name = "${module.demo_web_asg.asg_id}"
}
...
module "demo_web_cpu_high_alarm" {
  ...
  statistic = "Average"
  threshold = "65"
  autoscaling_group_name = "${module.demo_web_asg.asg_name}"
  alarm_description ="scale up if CPU utlization is > 65% over 3 minutes"
  alarm_actions = "${module.demo_web_asg_scale_up.scale_policy_arn}"
...
module "demo_web_cpu_low_alarm" {
  ...
  alarm_actions = "${module.demo_web_asg_scale_down.scale_policy_arn}"
...
module "demo_web_elb_5XX_alarm" {
  ...
  statistic = "Sum"
  threshold = "5"
  loadbalancer_name = "${module.demo_web_elb.elb_name}"
